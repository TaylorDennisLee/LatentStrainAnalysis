...
mkdir hashed_reads
python2 LSA/create_hash.py -i original_reads/ -o hashed_reads/ -k $kmerLen -s $hashSize > Logs/CreateHash.log 2>&1
...
python2 LSA/hash_fastq_reads.py -r {} -i original_reads/ -o hashed_reads/ >> Logs/HashReads.log 2>&1' \
::: $(seq 1 $numInputFiles)
...
python2 LSA/merge_hashq_files.py -r {} -i hashed_reads/ -o hashed_reads/ >> Logs/MergeHash.log 2>&1; \
python2 LSA/merge_hashq_fractions.py -r {} -i hashed_reads/ -o hashed_reads/ >> Logs/CombineFractions.log 2>&1' \
::: $(seq 1 $numInputFiles)
...
python2 LSA/tfidf_corpus.py -i hashed_reads/ -o cluster_vectors/ > Logs/GlobalWeights.log 2>&1
...
python2 LSA/kmer_corpus.py -r {} -i hashed_reads/ -o cluster_vectors/ >> Logs/KmerCorpus.log 2>&1' \
::: $(seq 1 $numInputFiles)
